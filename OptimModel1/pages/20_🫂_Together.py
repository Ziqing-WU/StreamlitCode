...
destination_path = "experimentations/together" + current_time + "/"
...
facility_activation_carbon_footprint = quicksum(xf[f, T[-1]] * af["F"] for f in F) + quicksum(xv[v, T[-1]] * af["V"] for v in V) + quicksum(xl[l, t] * of["L"] for l in L for t in T) + quicksum(xr[r, t] * of["R"] for r in R for t in T)
